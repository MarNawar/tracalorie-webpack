...
class CalorieTracker{
  ...
  removeMeal(id){
    const index = this._meal.findIndex((meal)=>{
      return id===meal.id
    });
  ...
  _displayCaloriesRemaining(){
    ...
    if(remaining<0){
      if(caloriesRemainingEl.parentElement.parentElement.classList.contains('bg-light')){
      ...
      if(caloriesRemainingEl.parentElement.parentElement.classList.contains('bg-danger')){
